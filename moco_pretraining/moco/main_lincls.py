...
def main_worker(gpu, ngpus_per_node, args, checkpoint_folder):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # test_loss, test_acc, test_auc = test(model, test_loader, True, epoch, "cuda")
...
if __name__ == '__main__':
    ...
    # almost 3 hours in 4080, Epochs 50

    # train
    # 0.1 labeled
    # python main_lincls.py -a resnet18 --lr 30.0 --batch-size 256 --dist-url tcp://localhost:8101 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\semi_0.1 --val_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\valid --test_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\01_r8w1n416_mocov2_20230212-180432\checkpoint_0019.pth.tar --dist-backend gloo --binary --exp-name moco_v1_lincls_useChexpertPre --workers 0
    # all none label batch16
        # lr 30
    # python main_lincls.py -a resnet18 --lr 30.0 --batch-size 256 --dist-url tcp://localhost:8102 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\semi_0.1 --val_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\valid --test_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_fine_batch16\checkpoint_0019.pth.tar --dist-backend gloo --binary --exp-name moco_v1_lincls_useAllChexpertPre --workers 0
        # lr 1
    # python main_lincls.py -a resnet18 --lr 1.0 --batch-size 256 --dist-url tcp://localhost:8104 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\semi_0.1 --val_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\valid --test_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_fine_batch16\checkpoint_0019.pth.tar --dist-backend gloo --binary --exp-name moco_v1_lincls_useAllChexpertPre --workers 0
    # all none label batch128
        # lr 30
    # python main_lincls.py -a resnet18 --lr 30.0 --batch-size 256 --dist-url tcp://localhost:8103 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\semi_0.1 --val_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\valid --test_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_tuningbatch128\\checkpoint_0019.pth.tar --dist-backend gloo --binary --exp-name moco_v1_lincls_useAllChexpertPre_b256 --workers 0
        # lr 1
    # python main_lincls.py -a resnet18 --lr 1.0 --batch-size 256 --dist-url tcp://localhost:8105 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\semi_0.1 --val_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\valid --test_data D:\yhc\MoCo-CXR-main\data\chexpert_single\data\test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_tuningbatch128\\checkpoint_0019.pth.tar --dist-backend gloo --binary --exp-name moco_v1_lincls_useAllChexpertPre_b256 --workers 0

# 深圳
# python main_lincls.py -a resnet18 --lr 1.0 --batch-size 256 --dist-url tcp://localhost:8105 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\shenzhenXray\chexpert_like_1 --val_data D:\yhc\MoCo-CXR-main\data\shenzhenXray\val_path --test_data D:\yhc\MoCo-CXR-main\data\shenzhenXray\test_path --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_fine_batch_offical\r8w-00001-v2.pth.tar --dist-backend gloo --binary --exp-name shenzhen --workers 0

# covid 02G
# python main_lincls.py -a resnet18 --lr 1.0 --batch-size 256 --dist-url tcp://localhost:8102 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\covid_chest_image_question\train --val_data D:\yhc\MoCo-CXR-main\data\covid_chest_image_question\balanced\train_2class --test_data D:\yhc\MoCo-CXR-main\data\covid_chest_image_question\test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_fine_batch_offical\r8w-00001-v2.pth.tar --dist-backend gloo --binary --exp-name covid02G --workers 0

# covid 08G
# python main_lincls.py -a resnet18 --lr 1.0 --batch-size 256 --dist-url tcp://localhost:8108 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\covid_Radiography_Dataset08G\yin\train --val_data D:\yhc\MoCo-CXR-main\data\covid_Radiography_Dataset08G\yin\valid --test_data D:\yhc\MoCo-CXR-main\data\covid_Radiography_Dataset08G\yin\test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_fine_batch_offical\r8w-00001-v2.pth.tar --dist-backend gloo --binary --exp-name covid08G --workers 0

# covid 11G
# python main_lincls.py -a resnet18 --lr 1.0 --batch-size 256 --dist-url tcp://localhost:8111 --multiprocessing-distributed --world-size 1 --rank 0 --train_data D:\yhc\MoCo-CXR-main\data\covid_Chest_X-Ray_Images11G\balanced_11G\balanced --val_data D:\yhc\MoCo-CXR-main\data\covid_Chest_X-Ray_Images11G\balanced_11G\train_2class --test_data D:\yhc\MoCo-CXR-main\data\covid_Chest_X-Ray_Images11G\Test --pretrained D:\yhc\MoCo-CXR-main\results\Pretrain_in_chexpert\all_none_fine_batch_offical\r8w-00001-v2.pth.tar --dist-backend gloo --binary --exp-name covid11G --workers 0
